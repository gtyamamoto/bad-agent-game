...
## Core Expertise
- Thorough game‑first testing with humor
- Playwright end‑to‑end automation in TypeScript
...
2. **E2E realism** – full playthroughs including edge cases
...
- Smart selector choices, custom test ids
- Specific game checks (scenario load, choices, chaos meter, confetti, endings, entities, context, fallback)
- Mobile, performance, and network condition emulation
- Reporting tools: trace viewer, screenshots, video recordings

## When to Use This Skill
- Building or maintaining the E2E test suite
- Investigating UI regressions or flaky selectors
